    ...
    <div class="rows">
        ...
        <div class="col-lg-6">
            <form class="form-signin" method="POST" action="#">
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">园区占地面积(km^2)</label> <input type="number" class="form-control" name="JBQK_SIZE" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <label for="InputName">已入园企业污水排放达标率(%)</label> <input type="number" class="form-control" name="JBQK_REACH_STANDARED_RATE" placeholder="" required><br/>
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">入园企业验收执行率</label> <input type="number" class="form-control" name="JBQK_CHECK_IMPLEMENT_RATE" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">入园企业环评执行率(%)</label> <input type="number" class="form-control" name="JBQK_ACCESS_IMPMEMENT_RATE" placeholder="" required><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;所属行业</label><input type="checkbox" name="JBQK_ACCEPTANCE_FACTOR_HANGYE" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;历史环境表现</label><input type="checkbox" name="JBQK_ACCEPTANCE_FACTOR_BIAOXIAN" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;拟建项目环评</label><input type="checkbox" name="JBQK_ACCEPTANCE_FACTOR_HUANPING" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;产业政策</label><input type="checkbox" name="JBQK_ACCEPTANCE_FACTOR_ZHENGCE" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;生产工艺先进程度</label><input type="checkbox" name="JBQK_ACCEPTANCE_FACTOR_CHENGDU" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;园区规划环评结论</label><input type="checkbox" name="JBQK_ACCEPTANCE_FACTOR_JIELUN" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;园区所在地环境功能区划</label><input type="checkbox" name="JBQK_ACCEPTANCE_FACTOR_QUHUA" placeholder="" >
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">年工业产值(亿元)</label> <input type="number" class="form-control" name="JBQK_YEAR_PROFIT" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">园区出让工业土地面积(km2)</label> <input type="number" class="form-control" name="JBQK_ACREAGE" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">园区年税收额(万元)</label> <input type="number" class="form-control" name="JBQK_TAX" placeholder="" required><br/>
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">园区公共绿地比率(%)</label> <input type="number" class="form-control" name="JBQK_GREEN_SPACE_RATE" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">排污费征收额度(万元/年)</label> <input type="number" class="form-control" name="JBQK_POLLUTION_EXPENSE" placeholder="" required><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;GB8978-1996《污水综合排放标准》</label><input type="checkbox" name="JBQK_POLLUTION_DISCHARGE_STANDARED_GB" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;地标《污水综合排放标准》</label><input type="checkbox" name="JBQK_POLLUTION_DISCHARGE_STANDARED_DB" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;行业标准</label><input type="checkbox" name="JBQK_POLLUTION_DISCHARGE_STANDARED_HY" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;《污水排入城镇下水道水质标准》CJ343-2010</label><input type="checkbox" name="JBQK_POLLUTION_DISCHARGE_STANDARED_CJ" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;其他标准</label><input type="checkbox" name="JBQK_POLLUTION_DISCHARGE_STANDARED_OTHER" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;协议</label><input type="checkbox" name="JBQK_POLLUTION_DISCHARGE_STANDARED_LC" placeholder="" ><br/><br/>
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">园区用水量(万m^3/d)</label> <input type="number" class="form-control" name="JBQK_WATER_USING" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">工业用水售价(元/m^3)</label> <input type="number" class="form-control" name="JBQK_WATER_VALUE" placeholder="" required><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">园区一般固废产生量(t/a)</label> <input type="number" class="form-control" name="JBQK_SOLID_PRODUCTION" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">园区危险固废产生量(t/a)</label> <input type="number" class="form-control" name="JBQK_DANGER_SOLID_PRODUCTION" placeholder="" required><br/>
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">排污收费的覆盖率/执行率(%)</label> <input type="number" class="form-control" name="JBQK_WASTE_EXPENSE_COVER_RATE" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">园区污水厂设计规模(m^3/d)(若有多个，请分别填写)</label> <input type="number" class="form-control" name="JBQK_WASTE_PROCESSING_SIZE" placeholder="" required><br/>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;有</label><input type="radio" name="JBQK_Y/N_ACCIDENT_POOL" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;无</label><input type="radio" name="JBQK_Y/N_ACCIDENT_POOL" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">园区事故水池容积(m^3)</label> <input type="number" class="form-control" name="JBQK_ACCIDENT_POOL_VOLUME" placeholder="" required><br/><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;是</label><input type="radio" name="YQCL_Y/N_INDUSTRIAL_LIFE_SEPERATION" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;否</label><input type="radio" name="YQCL_Y/N_INDUSTRIAL_LIFE_SEPERATION" placeholder="" required><br/><br/>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">工业废水分质分类收集</label><br/>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;是</label><input type="radio" name="YQCL_Y/N_COLLECTION_SEPERATION" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;否</label><input type="radio" name="YQCL_Y/N_COLLECTION_SEPERATION" placeholder="" required><br/><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;有</label><input type="radio" name="YQCL_Y/N_FEATURED_POLLUTION_MONITORING" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;无</label><input type="radio" name="YQCL_Y/N_FEATURED_POLLUTION_MONITORING" placeholder="" required><br/><br/>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;流量</label><input type="checkbox" name="YQCL_MONITORING_FACTOR_LIU" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;pH</label><input type="checkbox" name="YQCL_MONITORING_FACTOR_PH" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;温度</label><input type="checkbox" name="YQCL_MONITORING_FACTOR_WEN" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;化学需氧量</label><input type="checkbox" name="YQCL_MONITORING_FACTOR_HUA" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;生化需氧量</label><input type="checkbox" name="YQCL_MONITORING_FACTOR_SHENG" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;氨氮</label><input type="checkbox" name="YQCL_MONITORING_FACTOR_AN" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;总氮</label><input type="checkbox" name="YQCL_MONITORING_FACTOR_DAN" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;总磷</label><input type="checkbox" name="YQCL_MONITORING_FACTOR_LIN" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;重金属</label><input type="checkbox" name="YQCL_MONITORING_FACTOR_ZHONG" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;难降解有机物</label><input type="checkbox" name="YQCL_MONITORING_FACTOR_NAN" placeholder="" >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;其他</label><input type="checkbox" name="YQCL_MONITORING_FACTOR_OTHER" placeholder="" ><br/><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;有</label><input type="radio" name="ZSHY_Y/N_REPRODUCE_WATER" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;无</label><input type="radio" name="ZSHY_Y/N_REPRODUCE_WATER" placeholder="" required><br/><br/>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">环保部门设置的回用率目标(%)</label> <input type="number" class="form-control" name="ZSHY_RESCYCLE_RATE" placeholder="" required><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;有</label><input type="radio" name="ZSHY_Y/N_RESCYCLE_NETWORK" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;无</label><input type="radio" name="ZSHY_Y/N_RESCYCLE_NETWORK" placeholder="" required><br/><br/>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">中水管网运行费用(元/m^3水)</label> <input type="number" class="form-control" name="ZSHY_NETWORK_RUNING_VALUE" placeholder="" required><br/>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <label for="InputName">年回用水量(m^3/a)</label> <input type="number" class="form-control" name="ZSHY_RESCYCLE_WATER_SIZE" placeholder="" required><br/><br/>
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">再生水售价(元/m^3)</label> <input type="number" class="form-control" name="ZSHY_RESCYCLE_WATER_VALUE" placeholder="" required><br/>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">再生水建设投资费用(万元)</label> <input type="number" class="form-control" name="ZSHY_RESCYCLE_CONSTRUCTION_COST" placeholder="" required><br/>
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">再生水厂或车间占地(m^2)</label> <input type="number" class="form-control" name="ZSHY_RESCYCLE_PLACE_SIZE" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">运行费用(万元/a)</label> <input type="number" class="form-control" name="ZSHY_RUNING_EXPENSE" placeholder="" required><br/>
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">制备再生水电耗(kWh/m^3)</label> <input type="number" class="form-control" name="ZSHY_RESCYCLE_PRODUCE_ELECTRICITY_COST" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">回用收益(万元/a)</label> <input type="number" class="form-control" name="ZSHY_RESCYCLE_PROFIT" placeholder="" required><br/>
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="InputName">投资回收期(a)</label> <input type="number" class="form-control" name="ZSHY_PROFIT_TIME" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <label for="InputName">一般固废产生量(t/a)<br/>（膜组件寿命、废活性炭产生量等）</label> <input type="number" class="form-control" name="ZSHY_SOLID_PRODUCTIVITY" placeholder="" required><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <label>如有企业间梯级利用请说明具体形式</label><input type="text" name="FSTJ_USAGE" placeholder="" required><br/><br/><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <label>如有，请提供相关文件作为附件</label>
                        <input type="file" name="" value=""><br/><br/><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        <label for="InputName">第三方环保服务商进入情况，存在的主要问题</label> <input type="text" class="form-control" name="YQGL_THIRD_PARTY" placeholder="" required><br/>
                    </div>
                    <div class="col-xs-12">
                        <label for="InputName">园区对企业污水排放的监管措施，以及违规或超标排放的处罚措施</label>
                        <textarea class="textarea form-control input-lg" rows="5" name="YQGL_MONITORING_PUNISHMENT_POLICY" title="" required></textarea><br/>
                    </div>
                    <div class="col-xs-12">
                        <label for="InputName">国家或地方法律法规、政策、标准的落实情况及存在的问题，包括政策的合理性和政策实施的有效性</label>
                        <textarea class="textarea form-control input-lg" rows="5" name="YQGL_LAW_PROBLEM" title="" required></textarea><br/><br/>
                    </div>
                </div>
