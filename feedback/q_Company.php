  		...
  		<div class="rows">
  			...
  			<div class="col-lg-6">
  				<form class="form-signin" method="POST" action="#" enctype="multipart/form-data">
					...
					<div class="form-group">
						<div class="col-xs-6">
							<label for="InputName">企业名称</label> <input type="text" class="form-control" name="QYXX_NAME" placeholder="" value="<?php echo $rows[3] ?>" <?php if($ac==0) echo "disabled" ?> >
						</div>
						<div class="col-xs-6">
					...
					<div class="form-group">
						...
						<div class="col-xs-6">
							<label for="InputName">设施事故数量(个)</label> <input type="number" class="form-control" name="WSCL_MUD_PRODUCTION" placeholder="" value="<?php echo $rows[77] ?>" <?php if($ac==0) echo "disabled" ?> ><br/>
						</div>
					</div>
