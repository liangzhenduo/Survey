        ...
        <div class="col-lg-6">
            <form class="form-signin" method="POST" action="#" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <label for="InputName">数据年限</label> <input type="date" class="form-control" name="REPORT_DATE" placeholder="" value="<?php echo $rows[2] ?>" <?php if($ac==0) echo "disabled" ?> ><br/><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <label for="InputName">建立时间</label> <input type="date" class="form-control" name="JBQK_FUNDING_TIME" placeholder="" value="<?php echo $rows[10] ?>" <?php if($ac==0) echo "disabled" ?> ><br/>
                    </div>
                </div>
