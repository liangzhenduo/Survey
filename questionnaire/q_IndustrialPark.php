...
if(!isset($_SESSION['username'])){		//未登录
    ...
    if($type!=3&&$type!=0){
        ...
        $query="INSERT INTO IndustrialParkQuestionnaire(ID) values(null)";
        $result = mysqli_query($con, $query);
        $query="select max(ID) from IndustrialParkQuestionnaire";
        $result = mysqli_query($con, $query);
            ...
            <form class="form-signin" method="POST" action="#" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;有</label><input type="radio" name="JBQK_COMPANY_OVERLOAD" value="1" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;无</label><input type="radio" name="JBQK_COMPANY_OVERLOAD" value="0" placeholder="" required>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        <label for="InputName">对企业超标/违规排放的处罚措施</label><br/>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;有</label><input type="radio" name="JBQK_WASTE_PROCESSING_OVERLOAD" value="1" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;无</label><input type="radio" name="JBQK_WASTE_PROCESSING_OVERLOAD" value="0" placeholder="" required>
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;有</label><input type="radio" name="JBQK_YN_ACCIDENT_POOL" value="1" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;无</label><input type="radio" name="JBQK_YN_ACCIDENT_POOL" value="0" placeholder="" required>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;是</label><input type="radio" name="YQCL_YN_INDUSTRIAL_LIFE_SEPERATION" value="1" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;否</label><input type="radio" name="YQCL_YN_INDUSTRIAL_LIFE_SEPERATION" value="0" placeholder="" required><br/><br/>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">工业废水分质分类收集</label><br/>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;是</label><input type="radio" name="YQCL_YN_COLLECTION_SEPERATION" value="1" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;否</label><input type="radio" name="YQCL_YN_COLLECTION_SEPERATION" value="0" placeholder="" required><br/><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;有</label><input type="radio" name="YQCL_YN_FEATURED_POLLUTION_MONITORING" value="1" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;无</label><input type="radio" name="YQCL_YN_FEATURED_POLLUTION_MONITORING" value="0" placeholder="" required><br/><br/>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;有</label><input type="radio" name="ZSHY_YN_REPRODUCE_WATER" value="1" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;无</label><input type="radio" name="ZSHY_YN_REPRODUCE_WATER" value="0" placeholder="" required><br/><br/>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;有</label><input type="radio" name="ZSHY_YN_RESCYCLE_NETWORK" value="1" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;无</label><input type="radio" name="ZSHY_YN_RESCYCLE_NETWORK" value="0" placeholder="" required><br/><br/>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;是</label><input type="radio" name="ZSHY_RESCYCLE_WATER_STABILITY" value="1" placeholder="" required>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;否</label><input type="radio" name="ZSHY_RESCYCLE_WATER_STABILITY" value="0" placeholder="" required><br/><br/>
                    </div>
                    <div class="col-xs-6">
