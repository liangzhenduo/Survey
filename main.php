...
//$con = mysqli_connect('localhost','root','password') or die("Unable to connect to MySQL");
//$a=mysqli_select_db('polluted', $con) or die("Unable to select the database");
