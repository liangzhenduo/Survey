        ...
        <div class="col-lg-6">
            <form class="form-signin" method="POST" action="#">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <label for="InputName">化学需氧量</label> <input type="text" step="0.001" class="form-control" name="JBQK_CHEMISTRY_PARAMETER_HUA" placeholder="" value=" <?php echo $rows[16] ?>" disabled >
                    </div>
                    <div class="col-xs-4">
                        <label for="InputName">生化需氧量</label> <input type="text" step="0.001" class="form-control" name="JBQK_CHEMISTRY_PARAMETER_SHENG" placeholder="" value=" <?php echo $rows[17] ?>" disabled >
                    </div>
                    <div class="col-xs-4">
                        <label for="InputName">氨氮</label> <input type="text" step="0.001" class="form-control" name="JBQK_CHEMISTRY_PARAMETER_AN" placeholder="" value=" <?php echo $rows[18] ?>" disabled >
                    </div>
                    <div class="col-xs-4">
                        <label for="InputName">总氮</label> <input type="text" step="0.001" class="form-control" name="JBQK_CHEMISTRY_PARAMETER_DAN" placeholder="" value=" <?php echo $rows[19] ?>" disabled >
                    </div>
                    <div class="col-xs-4">
                        <label for="InputName">总磷</label> <input type="text" step="0.001" class="form-control" name="JBQK_CHEMISTRY_PARAMETER_LIN" placeholder="" value=" <?php echo $rows[20] ?>" disabled >
                    </div>
                    <div class="col-xs-4">
                        <label for="InputName">其他</label> <input type="text" step="0.001" class="form-control" name="JBQK_CHEMISTRY_PARAMETER_OTHER" placeholder="" value=" <?php echo $rows[21] ?>" disabled ><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <label for="InputName">名称</label> <input type="text" class="form-control" name="JBQK_WASTEWATER_TREATMENT1_NAME" placeholder="" value=" <?php echo $rows[22] ?>" disabled >
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">运营单位</label> <input type="text" class="form-control" name="JBQK_WASTEWATER_TREATMENT1_RUNNING" placeholder="" value=" <?php echo $rows[23] ?>" disabled >
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">排水去向</label> <input type="text" class="form-control" name="JBQK_WASTEWATER_TREATMENT1_WATER_DIRECTION" placeholder="" value=" <?php echo $rows[24] ?>" disabled >
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">设计规模(m^3/d)</label> <input type="text" step="0.001" class="form-control" name="JBQK_WASTEWATER_TREATMENT1_SIZE" placeholder="" value=" <?php echo $rows[25] ?>" disabled ><br/>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">名称</label> <input type="text" class="form-control" name="JBQK_WASTEWATER_TREATMENT2_NAME" placeholder="" value=" <?php echo $rows[26] ?>" disabled >
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">运营单位</label> <input type="text" class="form-control" name="JBQK_WASTEWATER_TREATMENT2_RUNNING" placeholder="" value=" <?php echo $rows[27] ?>" disabled >
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">排水去向</label> <input type="text" class="form-control" name="JBQK_WASTEWATER_TREATMENT2_WATER_DIRECTION" placeholder="" value=" <?php echo $rows[28] ?>" disabled >
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">设计规模(m^3/d)</label> <input type="text" step="0.001" class="form-control" name="JBQK_WASTEWATER_TREATMENT2_SIZE" placeholder="" value=" <?php echo $rows[29] ?>" disabled ><br/>
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">名称</label> <input type="text" class="form-control" name="JBQK_WASTEWATER_TREATMENT3_NAME" placeholder="" value=" <?php echo $rows[30] ?>" disabled >
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">运营单位</label> <input type="text" class="form-control" name="JBQK_WASTEWATER_TREATMENT3_RUNNING" placeholder="" value=" <?php echo $rows[31] ?>" disabled >
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">排水去向</label> <input type="text" class="form-control" name="JBQK_WASTEWATER_TREATMENT3_WATER_DIRECTION" placeholder="" value=" <?php echo $rows[32] ?>" disabled >
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">设计规模(m^3/d)</label> <input type="text" step="0.001" class="form-control" name="JBQK_WASTEWATER_TREATMENT3_SIZE" placeholder="" value=" <?php echo $rows[33] ?>" disabled ><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <input type="checkbox" value="1" name="YQQY_COMPANY_CATEGORIES_HUA" placeholder="" <?php if($rows[40]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;冶金</label><input type="hidden" name="YQQY_COMPANY_CATEGORIES_YE" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_CATEGORIES_YE" placeholder="" <?php if($rows[41]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;纺织印染</label><input type="hidden" name="YQQY_COMPANY_CATEGORIES_FANG" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_CATEGORIES_FANG" placeholder="" <?php if($rows[42]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;生物医药</label><input type="hidden" name="YQQY_COMPANY_CATEGORIES_SHENG" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_CATEGORIES_SHENG"  placeholder="" <?php if($rows[43]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;造纸工业</label><input type="hidden" name="YQQY_COMPANY_CATEGORIES_ZAO" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_CATEGORIES_ZAO" placeholder="" <?php if($rows[44]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;电子电工</label><input type="hidden" name="YQQY_COMPANY_CATEGORIES_DIAN" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_CATEGORIES_DIAN" placeholder="" <?php if($rows[45]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;机械</label><input type="hidden" name="YQQY_COMPANY_CATEGORIES_JI" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_CATEGORIES_JI" placeholder="" <?php if($rows[46]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;轻工食品</label><input type="hidden" name="YQQY_COMPANY_CATEGORIES_QING" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_CATEGORIES_QING" placeholder="" <?php if($rows[47]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;新型材料</label><input type="hidden" name="YQQY_COMPANY_CATEGORIES_XIN" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_CATEGORIES_XIN" placeholder="" <?php if($rows[48]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;印刷包装</label><input type="hidden" name="YQQY_COMPANY_CATEGORIES_YIN" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_CATEGORIES_YIN" placeholder="" <?php if($rows[49]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;现代制造</label><input type="hidden" name="YQQY_COMPANY_CATEGORIES_XIAN" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_CATEGORIES_XIAN" placeholder="" <?php if($rows[50]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;其他</label><input type="text" name="YQQY_COMPANY_CATEGORIES_OTHER" placeholder="" value=" <?php echo $rows[51] ?>" disabled ><br/><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <label for="InputName">环评</label> <input type="text" step="0.001" max="100" class="form-control" name="YQQY_ENVIRONMENT_PROTECTION_HUAN" placeholder="" value=" <?php echo $rows[52] ?>" disabled >
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">清洁生产</label> <input type="text" step="0.001" max="100" class="form-control" name="YQQY_ENVIRONMENT_PROTECTION_QING" placeholder="" value=" <?php echo $rows[53] ?>" disabled >
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">ISO14001认证</label> <input type="text" step="0.001" max="100" class="form-control" name="YQQY_ENVIRONMENT_PROTECTION_ISO" placeholder="" value=" <?php echo $rows[54] ?>" disabled >
                    </div>
                    <div class="col-xs-6">
                        <label for="InputName">总量控制</label> <input type="text" step="0.001" max="100" class="form-control" name="YQQY_ENVIRONMENT_PROTECTION_ZONG" placeholder="" value=" <?php echo $rows[55] ?>" disabled ><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <input type="checkbox" value="1" name="YQQY_STANDARD_GB" placeholder="" <?php if($rows[58]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;地标《污水综合排放标准》</label><input type="hidden" name="YQQY_STANDARD_DB" value="0">
                        <input type="checkbox" value="1" name="YQQY_STANDARD_DB" placeholder="" <?php if($rows[59]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;行业标准</label><input type="hidden" name="YQQY_STANDARD_HY" value="0">
                        <input type="checkbox" value="1" name="YQQY_STANDARD_HY" placeholder="" <?php if($rows[60]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;《污水排入城镇下水道水质标准》CJ343-2010</label><input type="hidden" name="YQQY_STANDARD_CJ" value="0">
                        <input type="checkbox" value="1" name="YQQY_STANDARD_CJ" placeholder="" <?php if($rows[61]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;其他标准</label><input type="hidden" name="YQQY_STANDARD_OTHER" value="0">
                        <input type="checkbox" value="1" name="YQQY_STANDARD_OTHER" placeholder="" <?php if($rows[62]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;协议</label><input type="hidden" name="YQQY_STANDARD_LC" value="0">
                        <input type="checkbox" value="1" name="YQQY_STANDARD_LC" placeholder="" <?php if($rows[63]==1){ ?> checked <?php } ?> disabled ><br/><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <input type="checkbox" value="1" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_HUA" placeholder="" <?php if($rows[68]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;冶金</label><input type="hidden" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_YE" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_YE" placeholder="" <?php if($rows[69]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;纺织印染</label><input type="hidden" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_FANG" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_FANG" placeholder="" <?php if($rows[70]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;生物医药</label><input type="hidden" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_SHENG" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_SHENG" placeholder="" <?php if($rows[71]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;造纸工业</label><input type="hidden" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_ZAO" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_ZAO" placeholder="" <?php if($rows[72]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;电子电工</label><input type="hidden" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_DIAN" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_DIAN" placeholder="" <?php if($rows[73]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;机械</label><input type="hidden" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_JI" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_JI" placeholder="" <?php if($rows[74]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;轻工食品</label><input type="hidden" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_QING" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_QING" placeholder="" <?php if($rows[75]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;新型材料</label><input type="hidden" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_XIN" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_XIN" placeholder="" <?php if($rows[76]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;印刷包装</label><input type="hidden" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_YIN" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_YIN" placeholder="" <?php if($rows[77]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;现代制造</label><input type="hidden" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_XIAN" value="0">
                        <input type="checkbox" value="1" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_XIAN" placeholder="" <?php if($rows[78]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;其他</label><input type="text" name="YQQY_COMPANY_HAVE_POOL_CATEGORY_OTHER" placeholder="" value=" <?php echo $rows[79] ?>" disabled ><br/><br/><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <input type="checkbox" value="1" name="YQGW_MONITORING_PARAMETERS_LIU" placeholder="" <?php if($rows[86]==1){ ?> checked <?php } ?>" disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;pH</label><input type="hidden" name="YQGW_MONITORING_PARAMETERS_PH" value="0">
                        <input type="checkbox" value="1" name="YQGW_MONITORING_PARAMETERS_PH" placeholder="" <?php if($rows[87]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;温度</label><input type="hidden" name="YQGW_MONITORING_PARAMETERS_WEN" value="0">
                        <input type="checkbox" value="1" name="YQGW_MONITORING_PARAMETERS_WEN" placeholder="" <?php if($rows[88]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;化学需氧量</label><input type="hidden" name="YQGW_MONITORING_PARAMETERS_HUA" value="0">
                        <input type="checkbox" value="1" name="YQGW_MONITORING_PARAMETERS_HUA" placeholder="" <?php if($rows[89]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;生化需氧量</label><input type="hidden" name="YQGW_MONITORING_PARAMETERS_SHENG" value="0">
                        <input type="checkbox" value="1" name="YQGW_MONITORING_PARAMETERS_SHENG" placeholder="" <?php if($rows[90]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;氨氮</label><input type="hidden" name="YQGW_MONITORING_PARAMETERS_AN" value="0">
                        <input type="checkbox" value="1" name="YQGW_MONITORING_PARAMETERS_AN" placeholder="" <?php if($rows[91]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;总氮</label><input type="hidden" name="YQGW_MONITORING_PARAMETERS_DAN" value="0">
                        <input type="checkbox" value="1" name="YQGW_MONITORING_PARAMETERS_DAN" placeholder="" <?php if($rows[92]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;总磷</label><input type="hidden" name="YQGW_MONITORING_PARAMETERS_LIN" value="0">
                        <input type="checkbox" value="1" name="YQGW_MONITORING_PARAMETERS_LIN" placeholder="" <?php if($rows[93]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;重金属</label><input type="hidden" name="YQGW_MONITORING_PARAMETERS_ZHONG" value="0">
                        <input type="checkbox" value="1" name="YQGW_MONITORING_PARAMETERS_ZHONG" placeholder="" <?php if($rows[94]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;难降解有机物</label><input type="hidden" name="YQGW_MONITORING_PARAMETERS_NAN" value="0">
                        <input type="checkbox" value="1" name="YQGW_MONITORING_PARAMETERS_NAN" placeholder="" <?php if($rows[95]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;其他</label><input type="hidden" name="YQGW_MONITORING_PARAMETERS_OTHER" value="0">
                        <input type="checkbox" value="1" name="YQGW_MONITORING_PARAMETERS_OTHER" placeholder="" <?php if($rows[96]==1){ ?> checked <?php } ?> disabled ><br/><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        <label for="InputName">再生水制备工艺</label> <input type="text" class="form-control" name="YQSZ_WASTEWATER_RESYCLE_MEANS" placeholder="" value=" <?php echo $rows[109] ?>" disabled><br/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-3">
                        <label for="InputName">金</label> <input type="text" step="0.001" class="form-control" name="YQSZ_RESYCLE_CATEGORIES_AND_VALUE_AU" placeholder="" value=" <?php echo $rows[117] ?>" disabled >
                    </div>
                    <div class="col-xs-3">
                        <label for="InputName">银</label> <input type="text" step="0.001" class="form-control" name="YQSZ_RESYCLE_CATEGORIES_AND_VALUE_AG" placeholder="" value=" <?php echo $rows[118] ?>" disabled >
                    </div>
                    <div class="col-xs-3">
                        <label for="InputName">铜</label> <input type="text" step="0.001" class="form-control" name="YQSZ_RESYCLE_CATEGORIES_AND_VALUE_CU" placeholder="" value=" <?php echo $rows[119] ?>" disabled >
                    </div>
                    <div class="col-xs-3">
                        <label for="InputName">镍</label> <input type="text" step="0.001" class="form-control" name="YQSZ_RESYCLE_CATEGORIES_AND_VALUE_NI" placeholder="" value=" <?php echo $rows[120] ?>" disabled >
                    </div>
                    <div class="col-xs-3">
                        <label for="InputName">镉</label> <input type="text" step="0.001" class="form-control" name="YQSZ_RESYCLE_CATEGORIES_AND_VALUE_CD" placeholder="" value=" <?php echo $rows[121] ?>" disabled >
                    </div>
                    <div class="col-xs-4">
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <input type="checkbox" value="1" name="YQWS_POLLUTION_CATEGORIES_HUA" placeholder="" <?php if($rows[128]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;生化需氧量BOD5</label><input type="hidden" name="YQWS_POLLUTION_CATEGORIES_SHENG" value="0">
                        <input type="checkbox" value="1" name="YQWS_POLLUTION_CATEGORIES_SHENG" placeholder="" <?php if($rows[129]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;氨氮NH3</label><input type="hidden" name="YQWS_POLLUTION_CATEGORIES_AN" value="0">
                        <input type="checkbox" value="1" name="YQWS_POLLUTION_CATEGORIES_AN" placeholder="" <?php if($rows[130]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;总氮TN</label><input type="hidden" name="YQWS_POLLUTION_CATEGORIES_DAN" value="0">
                        <input type="checkbox" value="1" name="YQWS_POLLUTION_CATEGORIES_DAN" placeholder="" <?php if($rows[131]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;总磷TP</label><input type="hidden" name="YQWS_POLLUTION_CATEGORIES_LIN" value="0">
                        <input type="checkbox" value="1" name="YQWS_POLLUTION_CATEGORIES_LIN" placeholder="" <?php if($rows[132]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;重金属</label><input type="hidden" name="YQWS_POLLUTION_CATEGORIES_ZHONG" value="0">
                        <input type="checkbox" value="1" name="YQWS_POLLUTION_CATEGORIES_ZHONG" placeholder="" <?php if($rows[133]==1){ ?> checked <?php } ?> disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;难降解有机物</label><input type="hidden" name="YQWS_POLLUTION_CATEGORIES_NAN" value="0">
                        <input type="checkbox" value="1" name="YQWS_POLLUTION_CATEGORIES_NAN" placeholder="" <?php if($rows[134]==1){ ?> checked <?php } ?>" disabled >
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;其他</label><input type="hidden" name="YQWS_POLLUTION_CATEGORIES_OTHER" value="0">
                        <input type="checkbox" value="1" name="YQWS_POLLUTION_CATEGORIES_OTHER" placeholder="" <?php if($rows[135]==1){ ?> checked <?php } ?> disabled ><br/><br/>
                    </div>
                </div>
